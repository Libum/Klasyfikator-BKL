...
DTM_sko2014 = removeSparseTerms(DTM_sko2014, sparse = 0.999)
...
#test$Wynik == NULL; test = cbind(test, DTM_sko2014)
...
library(ROCR)
ROCRpred = prediction(predictions = pred, labels = test$Wynik)
